...
import Content1 from '../../../../ui-to-api-switchers/create-manage/ui-datasets.md';
import Content2 from '../../../../ui-to-api-switchers/create-manage/api-datasets.md';

function ToggleDatasetsPage() {
...
export default ToggleDatasetsPage;