...
public class ClarifaiExample {
    ...
    static final String APP_ID = "Llama-3";
    // Change these to whatever model and text you want to use
    static final String MODEL_ID = "Llama-3_2-3B-Instruct"; 
    static final String MODEL_VERSION_ID = "52528868e11d431fa0450f00b22af18c";   
    static final String RAW_TEXT = "What is the future of AI?";
