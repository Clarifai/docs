---
description: Build and import models, including from external sources like Hugging Face and OpenAI
...
**Build and import models, including from sources like Hugging Face and OpenAI**
...
See the [example below](#llama-32-1b-instruct) for how to define Hugging Face checkpoints.
...
- [NSFW Image Classifier](https://github.com/Clarifai/runners-examples/tree/main/image-clasifier/nsfw-image-classifier)
