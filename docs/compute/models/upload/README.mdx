...
You can refer to the [examples below](#examples) to help you configure your files correctly.
...
Once the model is successfully uploaded to Clarifai, you can start making [predictions](https://docs.clarifai.com/compute/models/inference/api) with it. 
