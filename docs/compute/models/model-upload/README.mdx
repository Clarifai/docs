...
You need to include at least one method decorated with `@ModelClass.method` to define [prediction endpoints](https://docs.clarifai.com/compute/models/model-inference).
