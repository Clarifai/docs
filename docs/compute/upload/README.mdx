...
The `compute.instance` shorthand (e.g., `g5.xlarge`) is expanded automatically into the full `inference_compute_info` section when deploying. You can use `clarifai model deploy --instance-info` to browse available instance types.
