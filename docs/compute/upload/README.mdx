...
By default, model images are built for the **linux/amd64** architecture. If needed, you can provide a comma-separated list of additional target platforms to build a multi-architecture image.
