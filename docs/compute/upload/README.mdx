...
To run reliably and efficiently, your model requires a dedicated compute environment consisting of a [cluster and a nodepool](https://docs.clarifai.com/compute/deployments/clusters-nodepools/).
...
You can follow [this guide](https://docs.clarifai.com/getting-started/set-up-compute) to set up your compute environment fast.
