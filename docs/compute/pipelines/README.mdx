...
Explore a collection of ready-to-use ML pipeline templates that let you quickly train, evaluate, and run models on the Clarifai platform [here](https://github.com/Clarifai/pipeline-examples).
