...
> **Note:** A runner is the actual running instance of your model. The number of Local Runners you can run on your machine depends on your [pricing plan](https://www.clarifai.com/pricing).
