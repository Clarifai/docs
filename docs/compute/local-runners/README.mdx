...
| `--suppress-toolkit-logs` | on | Show toolkit logs (useful for debugging [Ollama](https://docs.clarifai.com/compute/local-runners/ollama/#step-4-start-your-local-runner)) |
