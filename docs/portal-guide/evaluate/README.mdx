...
You can run the evaluation on a specific model version of your custom model in the [Portal](https://portal.clarifai.com/). 

Go to your Application, click on your model of interest, and select the Versions tab. And simply click on the Evaluate button for the specific model version.
...
For more information on how to interpret the evaluation results and to improve your model, check the [Interpreting Evaluations](../evaluate/interpreting-evaluations/) section. 
