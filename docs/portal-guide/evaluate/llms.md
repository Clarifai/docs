...
After running the evaluation, the prompt templates will be ranked, allowing you to select the best-performing prompt-model combinations to use for creating [workflows](https://docs.clarifai.com/portal-guide/workflows/working_with_workflows/).  
