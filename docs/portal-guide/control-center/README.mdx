...
It is selected by default when you access the Control Center. If needed, you can also manually access it by selecting the Overview tab in the collapsible left sidebar.

You can look at it to get a quick summary of the activities you undertook. 
...
:::caution upgrade your plan

If you are a free user, you can still use the Control Center to track your metrics for a specified date range, and have the option of upgrading to a higher pricing plan. 
...
- You can also remove a chart from the section by simply clicking the delete button (X) in the upper-right corner. This action will only remove the chart from the section, without deleting it from the Control Center. 
