...
A dataset is a collection of data examples you can use to train, test, and evaluate your machine learning model. With Clarifai datasets, you can manage the data you want to use for visual search, model training, and evaluation. 
