...
You can select the model you want to see its details on the version selection pane on the left side of the page. Your selected version will be highlighted. By default, the best performing model is highlighted and appears on top. 
