...
- All new organization accounts are created on the Community [pricing plan](https://www.clarifai.com/pricing) by default, with the option to upgrade at any time. This applies to users on the Community, Essential, and Professional plans. Enterprise users are not affected.
