...
* Setting up  the Clarifai SDKs along with PAT . Refer the installation and configuration with PAT token [here](https://docs.clarifai.com/python-sdk/sdk-overview/).
