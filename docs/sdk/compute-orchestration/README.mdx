...
- Run the following command to clone the [repository](https://github.com/Clarifai/examples/tree/main) containing various Compute Orchestration examples: `git clone https://github.com/Clarifai/examples.git`. After cloning, navigate to the `ComputeOrchestration` folder to follow along with this tutorial.
