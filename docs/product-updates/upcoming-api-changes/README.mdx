...
| Date | Change | Details |
| :--- | :--- | :--- |
|  November 5th, 2024   | Changes to the use of PATs and API keys   | **(Breaking change)**  Critical changes to the use of PATs and API keys. Learn more [here](./pat-api-keys) |
