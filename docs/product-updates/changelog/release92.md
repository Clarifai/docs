...
|--------------------------------------|------------------------|---------------------------|
|![new-feature](/img/new_feature.jpg)|Added single sign-on (SSO) registration option|<ul><li>You can now use the SSO feature to sign up on our platform using your Google account.</li></ul>|
