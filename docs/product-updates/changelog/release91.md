...
|![new-feature](/img/new_feature.jpg)|Created the text-to-audio model type|<ul><li>You can now create a text-to-audio model type and train a model that converts text to audio.</li></ul>|
