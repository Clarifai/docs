...
You’ll be redirected to the deployment creation page, where the fields are pre-filled for you — such as the Deployment ID, [PAT](https://docs.clarifai.com/control/authentication/pat) (for authentication), and Nodepool. 
